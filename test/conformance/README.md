# EyeDual profile conformance suite

This directory contains executable tests for the EyeDual implementation and
reasoner.
[*The Art of EyeDual*](../../the-art-of-eyedual.md) is the reference for the
...
“Conformance” here means conformance to EyeDual's documented ISO compatibility
...
other directories cover EyeDual host contracts and extensions.
...
- `conformance/expected/<name>.pl` — exact expected standard output, stored as EyeDual-readable facts.
...
The corpus has 279 cases in `iso/` and 686 file-based conformance cases in
