// Depth-first EyeDual solver with builtin dispatch, memoization, and guarded recursion handling.
...
export class Solver {
  constructor(program, options = {}) {
    ...
    this.prologFlags = options.prologFlags ?? defaultPrologFlags(this.registry?.eyeDualLibrary ? 'fail' : 'error');
  ...
  *solve(goals, env = new Env(), depth = 0) {
    ...
    try {
      ...
      while (true) {
        ...
        // EyeDual normally solves left-to-right, but ready deterministic builtins can
