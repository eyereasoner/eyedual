// Portable Prolog clauses bundled with the standard Eyepl runtime.
// Kept in a browser-safe standalone module so the playground can verify and
// inject the exact library source even when an HTTP cache contains stale code.
