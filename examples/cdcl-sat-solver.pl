...
% backjumping, clause databases, restarts, and activity heuristics.  EyeDual has
...
% EyeDual cannot pass predicates as first-class values, so this small dispatcher
