...
% backjumping, clause databases, restarts, and activity heuristics.  WebEntail has
...
% WebEntail cannot pass predicates as first-class values, so this small dispatcher
