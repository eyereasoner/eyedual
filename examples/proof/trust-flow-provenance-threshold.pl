  ...
  proof(
    ...
    uses([
      ...
      proof(
        ...
        by(fact("trust-flow-provenance-threshold.pl", clause(11)))
      ),
      proof(
  ...
  proof(
    ...
    uses([
      ...
      proof(
        ...
        by(fact("trust-flow-provenance-threshold.pl", clause(10)))
      ),
      proof(
        goal(quality_score(transform_b, 0.80)),
        by(fact("trust-flow-provenance-threshold.pl", clause(12)))
      ),
      proof(
...
why(
  ...
  proof(
    ...
    by(rule("trust-flow-provenance-threshold.pl", clause(15))),
    ...
    uses([
      ...
      proof(
        ...
        by(fact("trust-flow-provenance-threshold.pl", clause(13)))
      ),
      proof(
...
why(
  ...
  proof(
    ...
    by(rule("trust-flow-provenance-threshold.pl", clause(16))),
...
why(
  ...
  proof(
    ...
    by(rule("trust-flow-provenance-threshold.pl", clause(17))),
...
why(
  ...
  proof(
    ...
    by(rule("trust-flow-provenance-threshold.pl", clause(18))),
