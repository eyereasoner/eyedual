...
project_contact('<https://github.com/eyereasoner/eyedual>', '<https://data.ugent.be/id/josd>', "josderoo@gmail.com").
why(
  project_contact('<https://github.com/eyereasoner/eyedual>', '<https://data.ugent.be/id/josd>', "josderoo@gmail.com"),
  proof(
    goal(project_contact('<https://github.com/eyereasoner/eyedual>', '<https://data.ugent.be/id/josd>', "josderoo@gmail.com")),
    by(rule("web-names.pl", clause(12))),
    bindings([binding("Project", '<https://github.com/eyereasoner/eyedual>'), binding("Person", '<https://data.ugent.be/id/josd>'), binding("Email", "josderoo@gmail.com")]),
    uses([
      proof(
        goal(triple('<https://github.com/eyereasoner/eyedual>', '<https://schema.org/maintainer>', '<https://data.ugent.be/id/josd>')),
