...
why(
  ...
  proof(
    ...
    by(rule("symbolic-derivative.pl", clause(15))),
  ...
  proof(
    ...
    uses([
      ...
      proof(
        ...
        by(rule("symbolic-derivative.pl", clause(9))),
