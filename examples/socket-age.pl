% socket-age.pl
%
% A small runnable eyeprolog Socket example for age reasoning.
%
% The socket facts are ordinary eyeprolog data. They document the semantic
